    ...
    >
              ...
              <div className="grid gap-1 grid-cols-2 mt-2">
                <div>
                  ...
                  <div className="mt-4">
                    ...
                    <p className="mt-1 uppercase text-green-300">{user.createdBy.name}</p>
                  </div>
                </div>
                <div className="ml-15">
                  <div>
                  ...
                  <div>
                    ...
                    <p className="mt-1 uppercase text-green-300">{user.updatedBy.name}</p>
                  </div>
                </div>
              </div>
              <div className="mt-4">
      ...
      <div className="pb-12">
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div className="p-6 text-gray-900 dark:text-gray-100">
              <TaskTable tasks={tasks} queryParams={queryParams} hideUserColoumn={true}/>
            </div>
          </div>
        </div>
      </div>
